	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="checkout-options">
				<h3>
                    <a href="javascript:;" class="btn btn-light" onclick="checkout.showModalAddress()" style="border: 1px solid black;" ><i class="fa fa-plus-square" aria-hidden="true"></i> Thêm địa chỉ</a>
                </h3>
                        ...
                        <div class="col-sm-6">
                            <div class="payment-options">
                                ...
                                <form id="payment_method">
                                    <input type="hidden" id="payment-method" name="payment-id" value="0">
                                    <span>
                                        <label><input name="payment_method" type="radio" value="1"> Thanh toán qua thẻ tín dụng/Ghi nợ</label>
                                    </span>
                                    <span>
                                        <label><input name="payment_method" type="radio" value="2">Thanh qua ví online</label>
                                    </span>
                                    <span>
                                        <label><input name="payment_method"  type="radio" value="3"> Thanh toán khi nhận hàng</label>
                                    </span>
                                </form>    
                                <div class="order-message">
                                    <textarea name="message" id="note" style="height: 10em"  placeholder="Lưu ý cho người bán" rows="16"></textarea>
                                </div>	   
                            </div>
                        </div>
                        
                        <div class="col-sm-6">
                            <div class="total_area" style="margin-right: 17px;">
                                <ul>
